...
from video_comparator.evaluation import (
    calculate_similarities_to_queries,
    extract_features,
)
...
if __name__ == "__main__":
    ...
    model = ViSiL(  # pylint: disable=invalid-name
        pretrained=True, symmetric="symmetric" in args.similarity_function
    ).to(args.gpu_id)
    model.eval()
