...
from analysis.environment_variables import GOOGLE_APPLICATION_CREDENTIALS, STAGE
from flows.environment_variables import IMAGE_NAME
...
def main(
    ...
    with Flow(
        ...
        dvc_remote_name = Parameter("dvc_remote_name", required=False)
        dvc_remote = Parameter("dvc_remote", required=False)
